...
function ProfileSidebar() {
  return (
    <div className="flex mt-6 flex-col">
      ...
      >
        <nav>
          <ul className=" divide-y-[1px] font-bold text-[15px] text-gray-600 divide-gray-200">
            ...
            <li>
              <button className="flex items-center py-2 gap-6 text-red-500 hover:text-red-600 transition w-full">
                <IoIosLogOut />
                <span>خروج</span>
              </button>
            </li>
